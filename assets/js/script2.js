...
<p>The feeling hurts, but naming it takes away some of its power and a weariness washes over Lila.</p> <p>All she wants to do is sleep. Sleep, and forget.</p>`,
    ...
    forest: {
        ...
        storyText: `<p>The forest is dark and opressive, and Lila feels trapped in a web she can't get out of.</p> <p>She can't <mark>accept</mark> what has happened or <mark>admit</mark> to herself that she doesn't feel <mark>okay</mark>. That things will never be the same again.</p> She loved to walk with them in the forest; they would tell her to <mark>go ahead</mark> and explore the paths and look for wildlife. They would encourage her to <mark>release</mark> her captured animal friends so they could run free. <p>Lila wants to feel free. The web around her starts to form the letters of a word... </p>`,
        storyText2: `Surrender. Lila must give in, not give up. <p>She needs to accept her loss, but she doesn't need to forget. She needs to remember the good things, the happy memories, the light and colour that lives in the world.</p> <p>The shadows lift, revealing the riotous colour of blossoms and leaves, which drift and fall around her. Dappled light drenches Lila, reminding her that warmth still exists after the cold dark, as the trees show her how to bend, not break.</p> <p>Her animal friends are with her, like <em>they</em> will always be with her.</p> `,
