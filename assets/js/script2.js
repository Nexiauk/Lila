...
const story = {
    ...
    intro: {
        ...
        storyText: `<p>Lila sits on her bed in the <mark>dark</mark>, a curtain of hair covering her face. Her soft plushies watch her with <mark>sad</mark> eyes and <mark>dejected</mark> expressions. Lila doesn't move, not even when her mum pops her head around the doorway and whispers, "Goodnight"; gently, carefully, as if anything above a whisper would shatter her fragile daughter.</p> <p>Lila doesn't respond. She can't.</p> <p>The door clicks softly shut and Lila stares at the magnetic board on the wall above her bed. She doesn't know how to voice what she's feeling, but maybe she could spell it out so that the <mark>ache</mark> in her heart will let her sleep...</p>`,
...
The feeling hurts, but naming it takes away some of its power and a weariness washes over Lila. <p>All she wants to do is sleep. Sleep, and forget.</p>`,
    ...
    void: {
        ...
        storyText: `Lila falls into troubled dreams, spinning slowly into a darkness that tries to swallow her whole. The gloom swirls around her in a cloud, trying to get into her eyes, nose, and mouth. She <mark>shakes her head</mark> and closes her eyes, buttons up her mouth, <mark>refuses</mark> to let it in. Lila <mark>turns from</mark> the darkness and all it represents, from the loss that she is feeling, but the more she <mark>ignores</mark> it the deeper it swallows her. She doesn't understand what she's feeling or how to make it stop. Letters coalesce in the void and she grabs them, tries to put them in an order that makes sense...`,
    ...
    forest: {
        ...
        storyText: `The forest is dark, oppressive, stifling. Lila feels trapped in a web she can't get out of. She can't <mark>accept</mark> what has happened - she doesn't want to. She can't <mark>admit</mark> to herself that they have gone, that they are forever gone, that she doesn't feel <mark>okay</mark> and that things will never be the same again. The forest used to be a place she loved to walk with them, underneath the whispering canopy of leaves. They would tell her to <mark>go ahead</mark> and explore the tranquil forest paths, to look for small animals. They would  encourage her to <mark>release</mark> her animal friends back into the wild, where they can run free.Lila wants to feel free. She just needs to... she must... she doesn't know what the word is.The web around her starts to form the letters of a word... `,
